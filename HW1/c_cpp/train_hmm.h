...
void calculate_alpha(const HMM* hmm, const char* observe_seq, int length, double** alpha);
void calculate_beta(const HMM* hmm, const char* observe_seq, int length, double** beta);
